...
class DataPenggajian extends CI_Controller{
    ...
    public function index()
    {
        ...
        $data['gaji'] =   $this->db->query("SELECT data_pegawai.nik,data_pegawai.nama_pegawai,data_pegawai.jenis_kelamin,data_jabatan.nama_jabatan,data_jabatan.gaji_pokok,data_jabatan.tj_transport,data_jabatan.uang_makan,data_kehadiran.alfa FROM data_pegawai
        ...
        $this->load->view('superadmin/dataGaji', $data);
        $this->load->view('templates_superadmin/footer');
    }

    public function cetakGaji()
    {
        $data['title'] = "Cetak Data Gaji Peggawai";
        if((isset($_GET['bulan']) && $_GET['bulan']!='') && 
          (isset($_GET['tahun']) && $_GET['tahun']!='')){
            $bulan= $_GET['bulan'];
            $tahun= $_GET['tahun'];
