...
class potonganGaji extends CI_Controller{
    ...
    public function index()
    {
        ...
        $this->load->view('superadmin/potonganGaji', $data);
    ...
    public function tambahData()
    {
        ...
        $this->load->view('templates_superadmin/header', $data);
        $this->load->view('templates_superadmin/sidebar');
        $this->load->view('superadmin/formPotonganGaji', $data);
        $this->load->view('templates_superadmin/footer');
    }
    ...
    public function tambahDataAksi()
    {
        ...
        if($this->form_validation->run() == FALSE){
            ...
            redirect('superadmin/potonganGaji');
        }
    }
    ...
    public function updateData($id)
    {
        ...
        $this->load->view('templates_superadmin/header', $data);
        $this->load->view('templates_superadmin/sidebar');
        $this->load->view('superadmin/updatePotonganGaji', $data);
        $this->load->view('templates_superadmin/footer');
    }
    ...
    {
        $this->form_validation->set_rules('potongan','jenis potongn','required');
        $this->form_validation->set_rules('jml_potongan','jumlah potongn','required');
    }
