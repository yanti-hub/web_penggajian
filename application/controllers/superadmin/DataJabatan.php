...
class DataJabatan extends CI_controller{
    ...
    public function index()
    {
        ...
        $this->load->view('superadmin/dataJabatan', $data);
    ...
    public function tambahData()
    {
        ...
        $this->load->view('templates_superadmin/header', $data);
        $this->load->view('templates_superadmin/sidebar');
        $this->load->view('superadmin/tambahDataJabatan', $data);
        $this->load->view('templates_superadmin/footer');
    }
    ...
    public function tambahDataAksi()
    {
        ...
        if($this->form_validation->run() == FALSE) {
            ...
            redirect('superadmin/dataJabatan');
        }
    }
    ...
    public function updateData($id)
    {
        ...
        $this->load->view('templates_superadmin/header', $data);
        $this->load->view('templates_superadmin/sidebar');
        $this->load->view('superadmin/updateDataJabatan', $data);
        $this->load->view('templates_superadmin/footer');
    }
