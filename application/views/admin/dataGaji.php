...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        ...
        <form class="form-inline">
            ...
            <div class="form-group mb-2 ml-5">
                ...
                <select class="form-control ml-2" name="tahun">
                    ...
                    <?php  $tahun = date ('Y');    for($i=2024;$i<$tahun+5;$i++) { ?>
        ...
        ?>
            ...
            <button type="submit" class="btn btn-primary mb-2 ml-auto"><i class="fas fa-eye">
    ...
    <div class="table-responsive">
        ...
        <span class="badge badge-danger">
            <i class="fas fa-info-circle"> Data Absensi masih kosong, silahkan input data kehadiran pada bulan dan tahun yang anda pilih. </i>
        </span>
    <?php } ?>
    </div>
</div>
