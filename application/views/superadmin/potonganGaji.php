...
<a class="btn btn-sm btn-success mb-2 mt-2" href="<?php echo base_url('superadmin/potonganGaji/tambahData') ?>"><i class="fas fa-plus"></i>Tambah Data</a>
...
<?php $no=1; foreach($pot_gaji as $p) : ?>
    <tr>
        ...
        <!-- <td>
            ...
            <a onclick="return confirm('Yakin Hapus')" class="btn btn-sm btn-danger mb-2 mt-2" href="<?php echo base_url('admin/potonganGaji/deleteData/'.$p->id) ?>"><i class="fas fa-trash"></i></a>
            </center>
        </td> -->
    </tr>
    <?php endforeach; ?>
